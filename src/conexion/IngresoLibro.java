...
public void limpiar(){
    ...
    private void btn_cerrar_sesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cerrar_sesionActionPerformed
        int opcion = JOptionPane.showConfirmDialog(this, "¿Està seguro que desea cerrar sesión?", "¡ALERTA!", JOptionPane.YES_NO_OPTION);
        if(opcion==0){
            dispose();
        }
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        String num_reg,titulo,autor,editorial,proce,f_pub,edicion,num_pag,clas,tipo,f_ingr,obs,fing_sis;
        String sql;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IngresoLibro dialog = new IngresoLibro(new javax.swing.JFrame(), true);
