...
public class ingreso_libro extends javax.swing.JFrame {

    conectar con=new conectar();
    Connection reg=con.conexion();
    public ingreso_libro() {
        initComponents();
...
public void limpiar(){
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if( evt.getButton()==1){
            ...
            try{
                ...
                this.txt_editorial.setText(rs.getString("num_pag"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ingreso_libro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ingreso_libro().setVisible(true);
            }
        });
    }
